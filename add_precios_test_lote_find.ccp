<Page id="1" templateExtension="html" relativePath="." fullRelativePath="." secured="True" urlType="Relative" isIncluded="False" SSLAccess="False" wizardTheme="InLine" wizardThemeType="File" needGeneration="0" accessDeniedPage="error_nivel.ccp" cachingEnabled="False" cachingDuration="1 minutes" isService="False">
	<Components>
		...
		<Grid id="2" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="5" name="test" connection="Datos" dataSource="test" pageSizeLimit="100" wizardCaption="Lista de Test " wizardTheme="Inline" wizardThemeType="File" wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="False" wizardAltRecord="True" wizardRecordSeparator="False" PathID="test">
			<Components>
				...
				<Hidden id="21" fieldSourceType="DBColumn" dataType="Text" html="False" editable="True" hasErrorCollection="True" name="test_id" wizardTheme="Inline" wizardThemeType="File" fieldSource="test_id" PathID="testtest_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<Hidden id="23" fieldSourceType="DBColumn" dataType="Text" html="False" editable="True" hasErrorCollection="True" name="h_nom_test" wizardTheme="Inline" wizardThemeType="File" fieldSource="nom_test" PathID="testh_nom_test">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Hidden id="22" fieldSourceType="DBColumn" dataType="Text" html="False" editable="True" hasErrorCollection="True" name="alt_test_id" wizardTheme="Inline" wizardThemeType="File" fieldSource="test_id" PathID="testalt_test_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<Hidden id="24" fieldSourceType="DBColumn" dataType="Text" html="False" editable="True" hasErrorCollection="True" name="h_alt_nom_test" wizardTheme="Inline" wizardThemeType="File" fieldSource="nom_test" PathID="testh_alt_nom_test">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="add_precios_test_lote_find_events.php" comment="//" codePage="utf-8" forShow="False"/>
		<CodeFile id="Code" language="PHPTemplates" name="add_precios_test_lote_find.php" comment="//" codePage="utf-8" forShow="True" url="add_precios_test_lote_find.php"/>
	</CodeFiles>
	<SecurityGroups>
