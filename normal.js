...
var gWeekDay=["Dom","Lun","Mar","Mié","Jue","Vie","Sáb"];	// weekday caption from Sunday to Saturday
...
var gsOutOfRange="Lo siento, no puede ir más allá del rango designado!";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
...
var gsNavPrev="<INPUT id='navPrev' type='button' value='&lt;' title='Mes anterior' class='MonthNav' onmousedown='showPrevMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the left month navigator
var gsNavNext="<INPUT id='navNext' type='button' value='&gt;' title='Mes siguiente' class='MonthNav' onmousedown='showNextMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the right month navigator

var gbHideBottom=false;	// true: hide the bottom section; false: show it with gsBottom.
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"No puede seleccionar HOY!\");return false;' onmouseover='return true;' title='Seleccionar la fecha de hoy'>Hoy : "+gMonths[gToday[1]-1]+" "+gToday[2]+", "+gToday[0]+"</A>";	// the content of the bottom section.
