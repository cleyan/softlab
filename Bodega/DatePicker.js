...
function buildDatePickerParts()
{
  ...
  DatePickerBegin =
      ...
      // Stylesheet defines appearance of DatePicker
      "<LINK REL=\"stylesheet\" TYPE=\"text/css\" HREF=\""+DatePickerObject.style+"\">" +
      "<TITLE> Date Picker </title><meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />" +
      "</HEAD>" +
  ...
  if (DatePickerObject.themeVersion!="3.0")
    DatePickerEnd +=
      ...
      (isNav?"":"<FORM NAME='calTable' onSubmit='return false;'>") +
      "<TD>" +
      "<INPUT TYPE='button' CLASS='CalendarButton' NAME='today' VALUE='Hoy' onClick=\"parent.opener.setToday()\">" + 
      "</TD>" + 
      (isNav?"":"</FORM>")+
      "</TABLE>" +
      (isNav?"</FORM>":"")+
