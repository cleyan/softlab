...
var gsBottom=(NN4?"":"<DIV class='BottomDiv'>")+"<A class='BottomAnchor' href='javascript:void(0)' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"No puede seleccionar HOY!\");return false;' onmouseover='return true;' >HOY</A>"+(NN4?"":"</DIV>");	// the content of the bottom section.
