<?php
//Include Common Files @1-908CAA10
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "win_add_firma.php");
...
//Class_Initialize Event @2-BA7FF9EF
...
//Operation Method @2-A980A2C8
    function Operation()
    {
        ...
        $Redirect = "win_add_firma.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
...
//DataSource Variables @2-B361F41C
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-E960949E
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "win_add_firma.html";
$BlockToParse = "main";
...
//Include events file @1-16049B82
include_once("./win_add_firma_events.php");
