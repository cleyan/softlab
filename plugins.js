...
var tmpBottom = (NN4?"":"<DIV class='BottomDiv'>")+"<A class='BottomAnchor' href='javascript:void(0)' onclick='if(this.blur)this.blur();fClearSelected();return false;' onmouseover='return true;'>Limpiar Todo</A>"+(NN4?"":"</DIV>");
...
function fStartPop(startc,endc) {
  ...
  gsBottom = gsBottom + "<br/>" + tmpBottom
