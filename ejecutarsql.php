...
//Inicializaci�n del Motor CPAINT
...
//Recupera el nombre de la funci�n que viene en el par�metro
...
global $cp;
	...
	if ($direccion=='') $direccion="Sin direcci�n registrada.";
	if ($fono=='') $fono="Sin tel�fono";
	...
	$datos ="<small>
			 ...
			 Ultima Petici�n: $ultimapeticion
			 </small>";



	//Nodos con los resultados de la b�squeda
