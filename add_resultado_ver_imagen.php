<?php
//Include Common Files @1-ABB793C4
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "add_resultado_ver_imagen.php");
...
class clsRecordresultados { //resultados Class @39-D4D14F9D
...
//Class_Initialize Event @39-2846E3E4
    function clsRecordresultados($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->archivo = new clsFileUpload("archivo", "archivo", "TEMP/", "resultado/", "*.bmp", "", 300000, $this);
            $this->img_archivo = new clsControl(ccsLabel, "img_archivo", "img_archivo", ccsText, "", CCGetRequestParam("img_archivo", $Method, NULL), $this);
            $this->img_archivo->HTML = true;
...
//Operation Method @39-24D3FB43
    function Operation()
    {
        ...
        $Redirect = "add_resultado_ver_imagen.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
...
//InsertRow Method @39-28289806
    function InsertRow()
    {
        ...
        $this->DataSource->img_archivo->SetValue($this->img_archivo->GetValue(true));
...
//Show Method @39-0C0F3BD8
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->img_archivo->Errors->ToString());
...
} //End resultados Class @39-FCB6E20C

class clsresultadosDataSource extends clsDBDatos {  //resultadosDataSource Class @39-3B02F926

//DataSource Variables @39-6144FE41
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @39-C123E6D2
    function clsresultadosDataSource(& $Parent)
    {
        ...
        $this->img_archivo = new clsField("img_archivo", ccsText, "");
...
} //End resultadosDataSource Class @39-FCB6E20C



//Initialize Page @1-D856F668
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "add_resultado_ver_imagen.html";
$BlockToParse = "main";
...
//Include events file @1-CA1CD6EF
include_once("./add_resultado_ver_imagen_events.php");
