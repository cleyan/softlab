...
//usuarios_usuarios_TotalRecords_BeforeShow @5-7AF263C6
...
//Close usuarios_usuarios_TotalRecords_BeforeShow @5-AE3D16EF
    return $usuarios_usuarios_TotalRecords_BeforeShow;
}
//End Close usuarios_usuarios_TotalRecords_BeforeShow

//Page_BeforeOutput @1-3E9E0E39
function Page_BeforeOutput(& $sender)
{
    $Page_BeforeOutput = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $cfg_seguridad; //Compatibility
