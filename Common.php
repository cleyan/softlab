...
//Connection Settings @0-4A2D71FD
...
$CCSLocales->AddLocale("es-CL", Array("es", "CL", array(1, 0, ""), 2, ",", ".", array("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"), array("Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic"), array("Domingo", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado"), array("Dom", "Lun", "Mar", "Mié", "Jue", "Vie", "Sáb"), array("D", "L", "M", "M", "J", "V", "S"), array("dd", "-", "mm", "-", "yyyy"), array("dddd", ", ", "dd", " de ", "mmmm", " de ", "yyyy"), array("H", ":", "nn"), array("H", ":", "nn", ":", "ss"), "", "", 0, false, "", "utf-8", "UTF-8", array(1, 7)));
$CCSLocales->DefaultLocale = strtolower("es-CL");
$CCSLocales->Init();
$Charset = "utf-8";
...
//Datos Connection Class @-03613CC8
class clsDBDatos extends DB_Adapter
{
    function clsDBDatos()
    {
        $this->Initialize();
    ...
    function Initialize()
    {
        ...
        $this->SetProvider($CCConnectionSettings["Datos"]);
        parent::Initialize();
...
//CCLoginUser @0-19E9C630
function CCLoginUser($login, $password)
{
    CCLogoutUser();
    $db = new clsDBDatos();
    $SQL = "SELECT usuario_id, nivel_acceso_id, clave FROM usuarios WHERE log_usuario=" . $db->ToSQL($login, ccsText) . " AND clave=" . $db->ToSQL($password, ccsText);
    $db->query($SQL);
