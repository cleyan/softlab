<?php
//Include Common Files @1-40C51F6F
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "add_perfil.php");
...
//Class_Initialize Event @2-D912693C
    function clsRecordperfiles($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->nom_perfil = new clsControl(ccsTextBox, "nom_perfil", "nombre perfil", ccsText, "", CCGetRequestParam("nom_perfil", $Method, NULL), $this);
...
//Operation Method @2-AE58EE55
    function Operation()
    {
        ...
        $Redirect = "add_perfil.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
...
//DataSource Variables @2-C15A1F65
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-72E841F7
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "add_perfil.html";
$BlockToParse = "main";
...
//Include events file @1-D5B6DC33
include_once("./add_perfil_events.php");
