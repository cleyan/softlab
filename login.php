...
//Class_Initialize Event @2-8BFE942D
    function clsRecordLogin($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->login = new clsControl(ccsTextBox, "login", "Usuario", ccsText, "", CCGetRequestParam("login", $Method, NULL), $this);
            $this->login->Required = true;
            $this->password = new clsControl(ccsTextBox, "password", "Contraseña", ccsText, "", CCGetRequestParam("password", $Method, NULL), $this);
