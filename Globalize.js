...
var arrayLocaleInfo = "{res:CCS_FormatInfo}".split("|");
    ...
    Globalize.cultures["default"] = {
        ...
        messages: {
          CCS_Now: "{res:CCS_Now}",
          CCS_RequiredField: "{res:CCS_RequiredField}",
          CCS_MinimumLength: "{res:CCS_MinimumLength}",
          CCS_MaximumLength: "{res:CCS_MaximumLength}",
          CCS_IncorrectFormat: "{res:CCS_IncorrectFormat}",
          CCS_IncorrectValue: "{res:CCS_IncorrectValue}"
        }
    };
