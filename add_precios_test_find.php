<?php
//Include Common Files @1-CF8C2BA1
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "add_precios_test_find.php");
...
//Operation Method @3-F3420A17
    function Operation()
    {
        ...
        $Redirect = "add_precios_test_find.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "add_precios_test_find.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Class_Initialize Event @2-C05421D7
    function clsGridtest($RelativePath, & $Parent)
    {
        ...
        $this->h_test_id = new clsControl(ccsHidden, "h_test_id", "h_test_id", ccsText, "", CCGetRequestParam("h_test_id", ccsGet, NULL), $this);
        $this->h_codigo_fonasa = new clsControl(ccsHidden, "h_codigo_fonasa", "h_codigo_fonasa", ccsText, "", CCGetRequestParam("h_codigo_fonasa", ccsGet, NULL), $this);
        ...
        $this->h_alt_test_id = new clsControl(ccsHidden, "h_alt_test_id", "h_alt_test_id", ccsText, "", CCGetRequestParam("h_alt_test_id", ccsGet, NULL), $this);
        $this->h_alt_codigo_fonasa = new clsControl(ccsHidden, "h_alt_codigo_fonasa", "h_alt_codigo_fonasa", ccsText, "", CCGetRequestParam("h_alt_codigo_fonasa", ccsGet, NULL), $this);
...
//Show Method @2-51D4477A
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            $this->ControlsVisible["h_test_id"] = $this->h_test_id->Visible;
            $this->ControlsVisible["h_codigo_fonasa"] = $this->h_codigo_fonasa->Visible;
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                if(!$this->IsAltRow)
                {
                    ...
                    $this->h_test_id->SetValue($this->DataSource->h_test_id->GetValue());
                    $this->h_codigo_fonasa->SetValue($this->DataSource->h_codigo_fonasa->GetValue());
                ...
                else
                {
                    ...
                    $this->h_alt_test_id->SetValue($this->DataSource->h_alt_test_id->GetValue());
                    $this->h_alt_codigo_fonasa->SetValue($this->DataSource->h_alt_codigo_fonasa->GetValue());
                    ...
                    $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeShowRow", $this);
                    $this->Attributes->Show();
                    $this->h_alt_test_id->Show();
                    $this->h_alt_codigo_fonasa->Show();
...
//GetErrors Method @2-23F8EA1D
    function GetErrors()
    {
        $errors = "";
        $errors = ComposeStrings($errors, $this->h_test_id->Errors->ToString());
        $errors = ComposeStrings($errors, $this->h_codigo_fonasa->Errors->ToString());
        ...
        $errors = ComposeStrings($errors, $this->h_alt_test_id->Errors->ToString());
        $errors = ComposeStrings($errors, $this->h_alt_codigo_fonasa->Errors->ToString());
...
//DataSource Variables @2-08B56B54
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
    ...
    // Datasource fields
    public $h_test_id;
    public $h_codigo_fonasa;
    public $h_nom_test;
    public $codigo_fonasa;
    public $cod_test;
    public $nom_test;
    public $h_alt_test_id;
    public $h_alt_codigo_fonasa;
...
//DataSourceClass_Initialize Event @2-D030281E
    function clstestDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Grid test";
        $this->Initialize();
        $this->h_test_id = new clsField("h_test_id", ccsText, "");
        
        $this->h_codigo_fonasa = new clsField("h_codigo_fonasa", ccsText, "");
        ...
        $this->h_alt_test_id = new clsField("h_alt_test_id", ccsText, "");
        
        $this->h_alt_codigo_fonasa = new clsField("h_alt_codigo_fonasa", ccsText, "");
...
//SetValues Method @2-8C0D1BCA
    function SetValues()
    {
        $this->h_test_id->SetDBValue($this->f("test_id"));
        $this->h_codigo_fonasa->SetDBValue($this->f("codigo_fonasa"));
        ...
        $this->h_alt_test_id->SetDBValue($this->f("test_id"));
        $this->h_alt_codigo_fonasa->SetDBValue($this->f("codigo_fonasa"));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "add_precios_test_find.html";
$BlockToParse = "main";
...
//Include events file @1-E0B7381F
include_once("./add_precios_test_find_events.php");
